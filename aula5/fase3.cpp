...
int main(int argc, char* argv[]) {
	...
	while(true) {
		...
		if (max_corrNCC > 0.55) {
			reta(a, linhaCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), linhaCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), COR(255,0,0));
			reta(a, linhaCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), linhaCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), COR(255,0,0));
			reta(a, linhaCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), linhaCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), COR(255,0,0));
			reta(a, linhaCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), linhaCC[ref_max_correNCC] - (19*pow(1.1541, ref_max_correNCC)/2), colCC[ref_max_correNCC] + (19*pow(1.1541, ref_max_correNCC)/2), COR(255,0,0));
